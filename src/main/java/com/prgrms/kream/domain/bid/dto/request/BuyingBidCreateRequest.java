...
public record BuyingBidCreateRequest(
		@ApiModelProperty(value = "구매 입찰 id", required = true, example = "1")
		@NotNull(message = "ID는 필수적으로 있어야 합니다")
		Long id,

		@ApiModelProperty(value = "구매 입찰 생성 요청자 id", required = true, example = "2")
		@NotNull(message = "구매 입찰을 올린 사람의 ID는 필수적으로 필요합니다")
		Long memberId,

		@ApiModelProperty(value = "상품 사이즈 id", required = true, example = "3")
